<?php
//0000000010s:7923:"<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
							...
							<div id='article-view' class="block first-block block-article-view">
								...
								<div class="block-content clearfix">
									<div class="article-head">
										<h1 class="title">HTML5 SVG 树枝分叉动画特效</h1>
										<div class="meta">
											<span class="item">分类：国内新闻</span>
											<span class="item">
												作者：
												<span class="yellow">admin</span>
											</span>
											<span class="item">来源：HTML5</span>
											<span class="item">點擊數：
											<script type="text/javascript" src="http://127.0.0.1/hdcms/index.php?a=Index&c=Index&m=getClick&mid=&cid=16&aid=5">
											</script>
											</span>
											<span class="item">
												发布：
												<span class="grey">2014-07-01 17:21:52</span>
											</span>
										</div>
									</div>
