...
CONTROLURL = '<?php echo $GLOBALS['user']['CONTROLURL'];?>';
    ...
    <script type="text/javascript" src="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/TemplateStyle/js/style_list.js"></script>
    <link type="text/css" rel="stylesheet" href="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/TemplateStyle/css/style_list.css"/>
</head>
<body>
