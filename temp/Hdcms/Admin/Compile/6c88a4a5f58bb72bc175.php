...
CONTROLURL = '<?php echo $GLOBALS['user']['CONTROLURL'];?>';
		...
		<script type="text/javascript" src="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/Index/js/menu.js"></script>
		<script type="text/javascript" src="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/Index/js/quick_menu.js"></script>
		<link type="text/css" rel="stylesheet" href="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/Index/css/css.css"/>
		<link type="text/css" rel="stylesheet" href="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/Index/css/quick_menu.css"/>
	</head>
	<body>
		<div class="nav">
			<!--头部左侧导航-->
...
echo "";
			...
			<div class="r_menu">
				...
				<span>|</span>
				<a href="http://127.0.0.1/hdcms/index.php" target="_blank">
					前台首页
				</a>
				<span>|</span>
