...
CONTROLURL = '<?php echo $GLOBALS['user']['CONTROLURL'];?>';
    ...
    <script type="text/javascript" src="http://127.0.0.1/hdcms/hd/Hdcms/Admin/Tpl/Category/js/addEdit.js"></script>
</head>
<body>
...
<div class="position-bottom">
    ...
    <input type="button" class="hd-cancel" value="取消" onclick="location.href='http://127.0.0.1/hdcms/index.php?a=Admin&c=Category'"/>
</div>
</form>
</body>
</html>